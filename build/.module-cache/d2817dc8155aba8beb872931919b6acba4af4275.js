...
$(document).ready(function() {
	...
	var initE = function() {
		...
		e[currentSlide].addEventListener("animationstart", listener, false);
		e[currentSlide].addEventListener("animationend", listener, false);
		e[currentSlide].addEventListener("animationiteration", listener, false);
	}
});
