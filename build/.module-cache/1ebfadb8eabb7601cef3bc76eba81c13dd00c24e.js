...
var SlideList = React.createClass({displayName: "SlideList",
  render: function() {
    var slideNodes = this.props.data.map(function (slide, index) {
      return React.createElement(Slide, {key: index, title: slide.look.description}, "http://res.cloudinary.com/misberri/image/upload/", slide.look.image.cloudinary_public_id);
    });
